...
const Product = () => {
    return (
        <div className="border-b border-gray-900/10 pb-12">
            ...
            <form action="submit.php" method="post" className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                    <button type="submit" className="bg-indigo-600 text-white py-2 px-4 rounded-md">Submit</button>
                </div>
            </form>
        </div>
    );
